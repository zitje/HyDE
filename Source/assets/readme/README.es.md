...
> [!TIP]
> También puedes agregar cualquier otra aplicación que desees instalar junto con HyDE. `Scripts/pkg_extra.lst` y pasar el archivo como parámetro para instalarlo así:
>
> ```shell
